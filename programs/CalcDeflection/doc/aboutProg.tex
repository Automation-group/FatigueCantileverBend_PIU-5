...
на усталось в установках ПИУ-4 и ПИУ-5. В программе задаются размеры образца,
выбирается ось вдоль которой приложена сила изгибающая образец и
сечение рычага к которому прикладывается изгибащая сила. Материалы из
которых изготовлены образец и рычаг определяются величиной модуля Юнга,
который для образца и рычага задаётся в разных полях ввода.
Кроме этого в программе можно вывести время расчёта, шаг интегрирования и
некоторые другие параметры о которых будет рассказано в следующих главах.

Поскольку для написания программы был использован кроссплатформенный фреймворк $Qt$,
то программа может быть собрана под различные операционные системы. Внешнишний вид
программы для \mbox{ОС Kubutu 24.04} представлен на Рис.\ref{fig:calcDeflection_linux}, а для
